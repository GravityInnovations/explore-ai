...
This directory is a user-owned test project inside the ExplainAI skill repository. When Faik invokes the installed skill here, the target root is this directory, not the parent repository or the skill's bundled example fixture.
...
- Use the installed `.agents/skills/explain-ai` copy. Do not edit the parent skill source to make a trial pass; report a demonstrated package issue instead.
